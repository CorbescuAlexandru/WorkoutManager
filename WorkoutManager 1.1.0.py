...
"""
    rezolva add_post
    adauga add_post la foru-urile din adduri  
...
class API:
    ...
    def cleanup(self):
        ...
        self.delete_field(API.url_plan, self.plans)
        self.delete_field(API.url_workout, self.workouts)
        self.delete_field(API.url_schl, self.schedules)
        self.delete_field(API.url_link, self.links)
